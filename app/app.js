...
const view = new MenuItem({
  label: "View",
  click: () => {
    $("#" + global.sharedObj['itemId'] + "-options").dialog({
      width: 535
    });
  }
});
...
agentMenu.append(shell); //agentMenu.append(modules);
  ...
  document.addEventListener("contextmenu", event => {
    ...
    switch (event.target.className) {
      ...
      case "menu-list-stager":
        ...
        listenerMenu.popup(_electron.remote.getCurrentWindow);
        break;
      ...
      case "agent agent-lin ui-draggable ui-draggable-handle":
        ...
        agentMenu.popup(_electron.remote.getCurrentWindow);
        break;
    }
  }, false);
}
